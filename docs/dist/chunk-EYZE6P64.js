import{e as Y}from"./chunk-4VQQINBR.js";import{a as w,c as V,e as x,i as d,m as I,n as T,o as j}from"./chunk-3CMR4JCK.js";var U="ibara-playlists",W="ibara-music-videos-cache-v2",O=24,$="all-streams",C=1,H="newest",M="grid",f=null,E=null,L=!1,k="",N=null;function g(){try{return JSON.parse(localStorage.getItem(U)||"[]")}catch{return[]}}function S(t){try{localStorage.setItem(U,JSON.stringify(t))}catch{}}function Z(t){let s=g(),e={id:String(Date.now()),name:t.trim(),createdAt:new Date().toISOString(),streams:[]};return s.unshift(e),S(s),e}function lt(t){S(g().filter(s=>s.id!==t))}function J(t,s){let e=g(),n=e.find(a=>a.id===t);return!n||n.streams.includes(s)?!1:(n.streams.push(s),S(e),!0)}function it(t,s){let e=g(),n=e.find(a=>a.id===t);n&&(n.streams=n.streams.filter(a=>a!==s),S(e))}function kt(t){return g().some(s=>s.streams.includes(t))}function _(){let t=w("#panel-playlists");if(!t)return;let s=Y.data?.streams||[],e=document.activeElement?.id==="pl-music-search",n=null;if(e){try{n=document.activeElement.selectionStart}catch{}k=document.activeElement.value||""}if(t.innerHTML=`
    <div class="pl-wrap">
      ...
      <div class="pl-subtab-body" id="pl-subtab-body">
        ${$==="all-streams"?X(s,C):$==="music"?ot():$t(s)}
      </div>
    </div>
  `,$==="music"&&dt(),e){let a=w("#pl-music-search");if(a&&(a.focus(),n!==null))try{a.setSelectionRange(n,n)}catch{}}t.onclick=a=>{let i=a.target.closest("[data-pl-subtab]");if(i){$=i.dataset.plSubtab,$==="all-streams"&&(C=1),_();return}let v=a.target.closest("[data-pl-sort]");if(v){H=v.dataset.plSort,C=1,K(s);return}let h=a.target.closest("[data-pl-page]");if(h&&!h.disabled){C=Number(h.dataset.plPage),K(s);return}let c=a.target.closest("[data-music-view]");if(c){M=c.dataset.musicView,B();return}let u=a.target.closest("[data-play-music]");if(u&&f?.length){let b=Number(u.dataset.playMusic);import("./chunk-JNXNGFR7.js").then(p=>p.playMusicQueue(f,b));return}let r=a.target.closest("[data-watch-music]");if(r&&f?.length){let b=Number(r.dataset.watchMusic),p=f[b];p?.url&&window.__openStreamViewer?.({url:p.url,title:p.title,isMv:!0});return}let l=a.target.closest("[data-playlist-add-mv]");if(l){let b=l.dataset.playlistAddMv,p=l.dataset.streamTitle||"";St("mv:"+b,p);return}$==="my-playlists"&&_t(a,s)},t.oninput=a=>{let i=a.target.closest("#pl-music-search");i&&(k=i.value||"",clearTimeout(N),N=setTimeout(B,100))},t.oncompositionend=a=>{let i=a.target.closest("#pl-music-search");i&&(k=i.value||"",clearTimeout(N),B())},t.addEventListener("error",a=>{let i=a.target;if(!i.classList.contains("pl-sg-thumb"))return;let v=i.dataset.fallback;v&&i.src!==v&&(i.src=v,delete i.dataset.fallback)},!0)}var rt=[{key:"newest",label:"\u65B0\u3057\u3044\u9806"},{key:"oldest",label:"\u53E4\u3044\u9806"},{key:"most-songs",label:"\u66F2\u6570\u2193"},{key:"fewest-songs",label:"\u66F2\u6570\u2191"}];function ct(t,s){let e=t.slice();return s==="oldest"?e.reverse():s==="most-songs"?e.sort((n,a)=>(a.songs?.length??0)-(n.songs?.length??0)):s==="fewest-songs"?e.sort((n,a)=>(n.songs?.length??0)-(a.songs?.length??0)):e}function X(t,s){if(!t.length)return`
      <div class="pl-empty-state">
        <p>\u914D\u4FE1\u30C7\u30FC\u30BF\u3092\u8AAD\u307F\u8FBC\u3093\u3067\u3044\u307E\u3059\u2026</p>
        <p class="pl-empty-hint">\u5148\u306B\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3\u30BF\u30D6\u3092\u958B\u304F\u3068\u3059\u3050\u306B\u8868\u793A\u3055\u308C\u307E\u3059</p>
      </div>`;let e=ct(t,H),n=e.length,a=Math.max(1,Math.ceil(n/O)),i=Math.min(Math.max(1,s),a),v=(i-1)*O,c=e.slice(v,v+O).map(l=>{let b=x(l),p=T(l.url),m=j(l.url),o=l.songs?.length??0;return`
    ...
    </div>`}<div class="pl-stream-grid" id="pl-stream-grid">${c}</div>${u}`}function K(t){let s=w("#pl-subtab-body");if(!s){_();return}s.innerHTML=X(t,C);let e=w("#panel-playlists");e&&e.addEventListener("error",n=>{let a=n.target;if(!a.classList.contains("pl-sg-thumb"))return;let i=a.dataset.fallback;i&&a.src!==i&&(a.src=i,delete a.dataset.fallback)},{once:!0,capture:!0}),s.scrollIntoView({behavior:"smooth",block:"start"})}function ot(){if(f===null){let t=F();t.length&&(f=t)}return tt(f||[])}async function dt(){if(f!==null){R();return}f=F(),L=!0,R();let t=await mt();L=!1,f=Array.isArray(t)?t:[],R()}function R(){if($!=="music")return;let t=w("#pl-subtab-body");t&&(w("#pl-music-search")?B():t.innerHTML=tt(f||[]))}function tt(t){return ut(t)+`<div id="pl-music-results">${st(t)}</div>`}function ut(t){let s=z(),n=q(t).length;return`
    ...
    </div>`}function st(t){let s=q(t);return L&&!t.length?'<div class="pl-empty-state"><p>\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</p><p class="pl-empty-hint">\u691C\u7D22\u6B04\u306F\u3053\u306E\u307E\u307E\u5165\u529B\u3067\u304D\u307E\u3059</p></div>':t.length?s.length?M==="grid"?Q(s):M==="list"?gt(s):M==="category"?ht(s):Q(s):L?`<div class="pl-empty-state"><p>\u6700\u65B0\u30C7\u30FC\u30BF\u3092\u78BA\u8A8D\u4E2D\u2026</p><p class="pl-empty-hint">\u300C${d(z())}\u300D\u306E\u5019\u88DC\u3092\u8AAD\u307F\u8FBC\u3093\u3067\u3044\u307E\u3059</p></div>`:'<div class="pl-empty-state"><p>\u4E00\u81F4\u3059\u308B\u52D5\u753B\u304C\u3042\u308A\u307E\u305B\u3093</p><p class="pl-empty-hint">\u300C\u66F2\u540D / \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u300D\u306E\u3088\u3046\u306B\u533A\u5207\u3063\u3066\u691C\u7D22\u3067\u304D\u307E\u3059</p></div>':'<div class="pl-empty-state"><p>\u52D5\u753B\u304C\u767B\u9332\u3055\u308C\u3066\u3044\u307E\u305B\u3093</p><p class="pl-empty-hint">\u7BA1\u7406\u753B\u9762\u304B\u3089\u767B\u9332\u3067\u304D\u307E\u3059</p></div>'}function z(){let t=w("#pl-music-search");return t&&(k=t.value||""),k}function B(){let t=f||[],s=w(".pl-music-count");if(s){let n=q(t).length;s.textContent=`${n}${n===t.length?"":` / ${t.length}`}\u4EF6`}document.querySelectorAll("[data-music-view]").forEach(n=>{n.classList.toggle("active",n.dataset.musicView===M)});let e=w("#pl-music-results");e&&(e.innerHTML=st(t))}function F(){try{let t=JSON.parse(localStorage.getItem(W)||"null");return Array.isArray(t?.videos)?t.videos:[]}catch{return[]}}function pt(t){try{localStorage.setItem(W,JSON.stringify({videos:t,cachedAt:Date.now()}))}catch{}}async function mt(){return E||(E=fetch("/data/music.json",{cache:"no-store"}).then(t=>t.ok?t.json():Promise.reject(new Error(`music.json ${t.status}`))).then(t=>{let s=Array.isArray(t?.videos)?t.videos:[];return pt(s),s}).catch(()=>f||F()),E)}function et(t){return String(t||"").normalize("NFKC").toLowerCase().replace(/[！-～]/g,s=>String.fromCharCode(s.charCodeAt(0)-65248)).replace(/[‐-‒–—―ー]/g,"-").replace(/\s+/g," ").trim()}function bt(t){return et(t).split(/[\/／|｜\s]+/).map(s=>s.trim()).filter(Boolean)}function vt(t){let s=t.title||"",e=s.split(/[\/／|｜]/).map(a=>a.trim()).filter(Boolean),n=P(t).label;return et([s,...e,t.originalArtist,t.character,t.type,n].filter(Boolean).join(" "))}function q(t){let s=bt(z()),e=t.map((n,a)=>({v:n,i:a}));return s.length?e.filter(({v:n})=>{let a=vt(n);return s.every(i=>a.includes(i))}):e}function P(t){switch(t.type){case"cover":return{label:"\u30AB\u30D0\u30FC",cls:"mv-badge-cover",sub:t.originalArtist||"\u30AB\u30D0\u30FC\u66F2"};case"sugariri":return{label:"\u3057\u3085\u304C\u308A\u308A",cls:"mv-badge-sugariri",sub:"\u3057\u3085\u304C\u308A\u308A"};default:return{label:"\u30AA\u30EA\u30B8\u30CA\u30EB",cls:"mv-badge-original",sub:"\u8328\u3080\u3042\u3093"}}}function at(t,s){let e=T(t.url),n=j(t.url),{label:a,cls:i,sub:v}=P(t);return`
    <div class="mv-card">
    ...
    </div>`}function ft(t,s){let{label:e,cls:n,sub:a}=P(t);return`
    <div class="mv-list-row">
      ...
      <button class="mv-add-btn" type="button"
        ...
        data-stream-title="${d(t.title||"")}"
        title="\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u306B\u8FFD\u52A0">\uFF0B</button>
    </div>`}function Q(t){return`<div class="mv-grid">${t.map(({v:s,i:e})=>at(s,e)).join("")}</div>`}function gt(t){return`<div class="mv-list">${t.map(({v:s,i:e})=>ft(s,e)).join("")}</div>`}function ht(t){return`
    <div class="mv-category">
      ${[{key:"original",label:"\u30AA\u30EA\u30B8\u30CA\u30EB\u66F2\uFF08\u500B\u4EBA\uFF09"},{key:"sugariri",label:"\u3057\u3085\u304C\u308A\u308A"},{key:"cover",label:"\u30AB\u30D0\u30FC\u66F2\uFF08\u6B4C\u307F\u305F\uFF09"}].map(({key:e,label:n})=>({label:n,items:t.filter(({v:a})=>a.type===e)})).filter(({items:e})=>e.length>0).map(({label:e,items:n})=>`
    ...
    </div>`}function Tt(){return f||[]}function yt(t){if(!t?.startsWith("mv:"))return null;let s=t.slice(3);return(f||[]).find(e=>e.id===s)||null}function $t(t){let s=g();return s.length?`
    ...
    <div class="pl-grid">
      ...
      <div class="pl-my-actions">
        <button class="pl-new-btn" id="pl-new-btn" type="button">\uFF0B \u65B0\u898F\u4F5C\u6210</button>
      </div>`}function wt(t,s){let e=t.streams.map(c=>{let u=c.startsWith("mv:"),r=u?yt(c):null;return{skey:c,isMv:u,mv:r,stream:u?null:s.find(l=>x(l)===c)}}),n=e.find(({stream:c,mv:u})=>c?.url||u?.url)?.stream?.url||e.find(({mv:c})=>c?.url)?.mv?.url,a=n?`<img class="pl-card-cover" src="${d(T(n))}" alt="" loading="lazy" referrerpolicy="no-referrer">`:"",i=e.length,v=e.map(({skey:c,isMv:u,mv:r,stream:l},b)=>{let p=d(t.id+"|:|"+c),m=`
      <div class="pl-sort-btns">
        ...
        </div>`;let{label:y,sub:A}=P(r),nt=r.type||"original",D=(f||[]).indexOf(r);return`
        <div class="pl-stream-row">
          ${m}
          <div class="pl-stream-info">
            <span class="pl-stream-date"><span class="mv-badge-inline mv-type-${nt}">${y}</span></span>
            <span class="pl-stream-title">${d(r.title||"\u2014")}</span>
            <span class="pl-stream-meta">${d(A)}</span>
          </div>
      ...
      </div>`}).join(""),h=e.map(({stream:c,mv:u})=>{let r=c?.url||u?.url;return r?I(r):""}).filter(Boolean);return`
    <div class="pl-card">
    ...
    </div>`}function _t(t,s){if(t.target.closest("#pl-new-btn")){Mt();return}let e=t.target.closest("[data-pl-share]");if(e){let r=g().find(o=>o.id===e.dataset.plShare);if(!r)return;let l=JSON.stringify({n:r.name,s:r.streams}),b=btoa(String.fromCharCode(...new TextEncoder().encode(l))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),p=`${location.origin}${location.pathname}?pl=${b}`,m=o=>{e.textContent=o?"\u2713 \u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F":"\u30B3\u30D4\u30FC\u3067\u304D\u307E\u305B\u3093",setTimeout(()=>{e.textContent="\u{1F517} \u30EA\u30F3\u30AF\u3092\u5171\u6709"},1600)};navigator.clipboard?.writeText(p).then(()=>m(!0)).catch(()=>{try{let o=document.createElement("textarea");o.value=p,o.style.cssText="position:fixed;opacity:0;",document.body.appendChild(o),o.select();let y=document.execCommand("copy");o.remove(),m(y)}catch{m(!1)}});return}let n=t.target.closest("[data-pl-del]");if(n){let r=n.dataset.plDel,l=g().find(b=>b.id===r);l&&confirm(`\u300C${l.name}\u300D\u3092\u524A\u9664\u3057\u307E\u3059\u304B\uFF1F`)&&(lt(r),_());return}let a=t.target.closest("[data-pl-rm-stream]");if(a){let[r,l]=a.dataset.plRmStream.split("|:|");it(r,l),_();return}let i=t.target.closest("[data-pl-play-stream]");if(i){let r=i.dataset.plPlayStream,l=s.find(b=>x(b)===r);l?.url&&window.__openStreamViewer?.(l);return}let v=t.target.closest("[data-play-music-pl]");if(v&&f?.length){let r=Number(v.dataset.playMusicPl);import("./chunk-JNXNGFR7.js").then(l=>l.playMusicQueue(f,r));return}let h=t.target.closest("[data-pl-rename]");if(h){let r=h.dataset.plRename,l=g().find(p=>p.id===r);if(!l)return;let b=prompt("\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u540D",l.name)?.trim();if(b){let p=g(),m=p.find(o=>o.id===r);m&&(m.name=b,S(p),_())}return}let c=t.target.closest("[data-pl-move]");if(c){let r=c.dataset.plMove.split("|:|"),[l,b,p]=r,m=g(),o=m.find(A=>A.id===l);if(!o)return;let y=o.streams.indexOf(b);if(y<0)return;p==="up"&&y>0?([o.streams[y-1],o.streams[y]]=[o.streams[y],o.streams[y-1]],S(m),_()):p==="down"&&y<o.streams.length-1&&([o.streams[y],o.streams[y+1]]=[o.streams[y+1],o.streams[y]],S(m),_());return}let u=t.target.closest("[data-pl-yt-share]");if(u){let r=u.dataset.plYtShare,l=g().find(m=>m.id===r);if(!l)return;let b=l.streams.map(m=>s.find(o=>x(o)===m)).filter(m=>m?.url).map(m=>I(m.url)).filter(Boolean);if(!b.length){alert("YouTube\u306EURL\u304C\u767B\u9332\u3055\u308C\u3066\u3044\u308B\u914D\u4FE1\u304C\u3042\u308A\u307E\u305B\u3093");return}let p=`https://www.youtube.com/watch_videos?video_ids=${b.join(",")}`;window.open(p,"_blank","noopener noreferrer");return}}function Mt(){let t=prompt("\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u540D\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044")?.trim();t&&(Z(t),_())}function St(t,s){let e=w("#pl-add-modal");e||(e=document.createElement("div"),e.id="pl-add-modal",e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),document.body.appendChild(e));let n=g(),a=()=>{let v=g(),h=v.length?v.map(c=>{let u=c.streams.includes(t);return`
