import{a as Zt,b as Xt,c as Qt,i as te,j as ee,k as N,l as Y}from"./chunk-2SVNDSRJ.js";import{a as se,b as ne,e as Et,f as ae}from"./chunk-U2GWFHGH.js";import"./chunk-2E6JXX77.js";import{a as Gt,b as _t,c as Wt,e as c}from"./chunk-4VQQINBR.js";import{a as tt,f as Mt}from"./chunk-HDKS545O.js";import{a as r,b as E,c as T,e as j,g as Tt,i as f,k as F,l as Jt}from"./chunk-3CMR4JCK.js";var L=-1,A=[],Ct=null,O=null,ht=null;function oe(t){Ct=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
    <div id="omni-box">
  ...
  </div>`}function Ne(){return O!==null?Promise.resolve(O):ht||(ht=fetch("/data/music.json",{cache:"no-store"}).then(t=>t.ok?t.json():Promise.reject(new Error(`music.json ${t.status}`))).then(t=>(O=Array.isArray(t?.videos)?t.videos:[],O)).catch(()=>(O=[],O)),ht)}function qe(t,e){let s=bt(e);if(!s.length)return!1;let n=Re(t);return s.every(a=>n.includes(a))}function Re(t){let e=t.title||"",s=e.split(/[\/／|｜]/).map(n=>n.trim()).filter(Boolean);return W([e,...s,t.originalArtist,t.character,t.type,ue(t)].filter(Boolean).join(" "))}function ue(t){switch(t?.type){case"cover":return"\u6B4C\u307F\u305F";case"sugarily":return"\u3057\u3085\u304C\u308A\u308A";default:return"\u30AA\u30EA\u66F2"}}function bt(t){return W(t).split(/[\/／|｜\s]+/).map(e=>e.trim()).filter(Boolean)}function re(t,e){let s=bt(t);if(!s.length)return!1;let n=W(e);return s.every(a=>n.includes(a))}function W(t){return String(t||"").normalize("NFKC").toLowerCase().replace(/\s+/g," ").trim()}function st(t,e){let n=bt(e).find(l=>l&&t.toLowerCase().includes(l))||W(e);if(!n)return t;let i=t.toLowerCase().indexOf(n);return i<0?t:t.slice(0,i)+'<mark class="hl">'+t.slice(i,i+n.length)+"</mark>"+t.slice(i+n.length)}ne();Wt();var ye={dashboard:()=>import("./chunk-VTTW3HSI.js").then(t=>t.renderDashboard),ranking:()=>import("./chunk-WNFWYMSO.js").then(t=>t.renderRanking),songs:()=>import("./chunk-KLY63KUZ.js").then(t=>t.renderSongs),timeline:()=>import("./chunk-R3VEYWHV.js").then(t=>t.renderTimeline),analytics:()=>import("./chunk-L62HWTF5.js").then(t=>t.renderAnalytics),playlists:()=>import("./chunk-PNVPGAEU.js").then(t=>t.renderPlaylists)},yt=new Map,ve=0,J=null;function kt(t){return Object.prototype.hasOwnProperty.call(ye,t)}async function Ue(t){yt.has(t)||yt.set(t,ye[t]());try{return await yt.get(t)}catch(e){throw yt.delete(t),e}}function ge(t){return["dashboard","timeline","analytics"].includes(t)}function je(t,e={}){let s=r(`#panel-${t}`);if(!s)return;let n={dashboard:"\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u8A73\u7D30",ranking:"\u30E9\u30F3\u30AD\u30F3\u30B0",songs:"\u66F2\u30EA\u30B9\u30C8",timeline:"\u914D\u4FE1\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3",analytics:"\u30A2\u30CA\u30EA\u30C6\u30A3\u30AF\u30B9"};s.innerHTML=`
  ...
  `)}function Ye(t){if(c.channelData?.fullLoaded)return;c.channelData=t;let e=R(c.channel)?c.channel:tt,s=R(e);s&&(c.data=s),!ge(c.activeTab)&&c.data&&z(c.activeTab,{autoLoad:!1})}function Oe(t){c.channelData=t,c.channelData.fullLoaded=!0;let e=R(c.channel)?c.channel:tt;St(e,{resetSearch:!1,updateUrl:!1,render:!1}),z(c.activeTab,{autoLoad:!1})}function we(){return J=Xt({meta:c.channelData,onSongsReady:Ye}).then(Oe).finally(()=>{J=null}),J}async function Vt(){c.channelData?.fullLoaded||(J||we(),await J)}async function z(t=c.activeTab,e={}){if(t!=="playlists"&&(!c.data||!kt(t))||!kt(t))return;let s=c.channelData?.partialLoaded||c.channelData?.fullLoaded,n=c.channelData?.fullLoaded;if(t==="playlists"?!1:ge(t)?!n:!s)if(e.autoLoad){Fe(t);try{await Vt()}catch(l){console.error("[data] full load failed",l);let d=r(`#panel-${t}`);d&&(d.innerHTML=`
            <div class="state-card">
